...
if is_admin:
    with tab_users:
            ...
            if st.form_submit_button("CADASTRAR NOVO ACESSO"):
                if nu_user and nu_pass:
                    try:
                        ...
                        sh = client.open_by_url(creds["spreadsheet"])
        ...
        # Leitura forçada sem cache pesado
        ...
        if not df_usuarios_ver.empty:
            ...
            st.info("Nenhum usuário encontrado na aba 'usuários'. Verifique se existem dados na planilha.")
